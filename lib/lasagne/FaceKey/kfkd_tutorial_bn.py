...
FTRAIN = r'C:\Theses\double_encoder\Datasets\FACE\training.csv'
FTEST = r'C:\Theses\double_encoder\Datasets\FACE\test.csv'
FLOOKUP = r'C:\Theses\double_encoder\Datasets\FACE\IdLookupTable.csv'
