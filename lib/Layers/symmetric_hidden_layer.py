...
class SymmetricHiddenLayer(object):
        ...
        def _initialize_input_weights(self, input_size):
            ...
            initial_Wx = numpy.asarray(self.numpy_range.normal(0, 0.1, size=(input_size, self.hidden_layer_size)), dtype=theano.config.floatX)
        ...
        def _initialize_output_weights(self, input_size):
            ...
            initial_Wy = numpy.asarray(self.numpy_range.normal(0, 0.1, size=(input_size, self.hidden_layer_size)), dtype=theano.config.floatX)
