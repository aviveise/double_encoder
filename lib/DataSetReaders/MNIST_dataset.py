...
class MNISTDataSet(DatasetBase):
    ...
    def build_dataset(self):
        ...
        x1_train_set, x1_tuning_set, test_samples = self.produce_optimization_sets(self.trainset[0], 0)
        x2_train_set, x2_tuning_set, test_samples = self.produce_optimization_sets(self.trainset[1], 0)
