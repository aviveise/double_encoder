...
def getVideo(file, start_frames, frame_count, index, file_name):
    ...
    for idx, start_index in enumerate(start_frames[0]):
        ...
        faces = face_detector.detectMultiScale(gray, minSize=(200, 150))
        ...
        for i in range(frame_count):
            ...
            gray = cv2.cvtColor(frame, cv2.COLOR_BGR2GRAY)
            face_gray = gray[max_face[1] + height * 0.60: max_face[1] + height * 0.95,
            ...
            mouths = mouth_detector.detectMultiScale(face_gray, 1.1, 4, 0, minSize=(60, 40))
