...
def getVideo(file, start_frames, frame_count, index, file_name):
    ...
    for idx, start_index in enumerate(start_frames[0]):
        ...
        for i in range(frame_count):
            ...
            faces = face_detector.detectMultiScale(gray, minSize=(220, 170))
            ...
            face_gray = gray[max_face[1] + height * 0.40: max_face[1] + height * 0.97,
            ...
            mouths = mouth_detector.detectMultiScale(face_gray, 1.1, 3, 0, minSize=(50, 10))
